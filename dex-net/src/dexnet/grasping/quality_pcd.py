...
from dexnet.grasping.grasp_pcd import PointGrasp
from dexnet.grasping.grasp_quality_config_pcd import GraspQualityConfig
...
class PointGraspMetrics3D:
    ...
    def grasp_quality(grasp, obj, params, contacts=None, vis=False):
        ...
        if not isinstance(obj, GraspableObjectPcd):
