...
from Classifier.model import Pointnet2MSG as Pointnet2
...
parser.add_argument('--tag', type=str, default='pointnet2')
...
def train(model, loader, epoch):
    ...
    for batch_idx, (data, target) in enumerate(loader):
        ...
        data = data.permute(0, 2, 1)  # pointnet2输入尺寸为[n, point_num, channels]
        if args.cuda:
